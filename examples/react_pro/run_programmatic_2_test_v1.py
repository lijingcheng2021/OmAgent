...
# 添加新的环境变量
os.environ['container_config'] = 'container_5.yaml'  # 容器配置文件路径
os.environ['workflow_config'] = 'configs_gsm8k'          # 工作流配置目录路径
# 设置参数
input_file = "/home/li_jingcheng/项目/dev/OmAgent/data/gsm8k_test.jsonl"
num_splits = 100  # 设置要切分的份数

# 创建输出目录
output_dir = "/home/li_jingcheng/项目/dev/OmAgent/data/gsm8k_qwen2.5-72b_pro_promptv1_testv0"
