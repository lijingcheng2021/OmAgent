...
from omagent_core.advanced_components.workflow.qa_analysis.workflow import QAAnalysisWorkflow
...
qa_workflow = QAAnalysisWorkflow()
qa_workflow.set_input(query=input_task.output('query'))

# Configure workflow execution flow
workflow >> input_task >> qa_workflow
